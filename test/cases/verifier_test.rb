...
class VerifierTest < ActiveSupport::TestCase
  ...
  if RUBY_VERSION > "1.9.3"
    test "generates URL-safe messages" do
      assert_equal "BAh7B0kiCGdpZAY6BkVUSSInZ2lkOi8vYmN4L1BlcnNvbi8xMTUxODY/ZXhwaXJlc19pbgY7AFRJIg9leHBpcmVzX2F0BjsAVDA=--ae5e44055262447fdbf5d5d39d5120cfa7d5fbe6",
